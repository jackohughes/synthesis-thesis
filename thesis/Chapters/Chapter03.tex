...
\textit{noLeak} & = \textbf{let}\ (x',\ y')\ =\ z\ \textbf{in}\ \\
...
% (usually drawn from some
% semiring structure parameterising the calculus). 
...
% schedules~\cite{DBLP:conf/esop/GhicaS14}. 
%
\begin{align}
\tag{\footnotesize{example}}
...
% \end{align*}
% Here $x$ is a linear assumption containg a pair of pairs. To reach the goal, $x$ needs to be 
...
% final synthesised terms will be behaviourlly equivalent: 
% \begin{align*}
